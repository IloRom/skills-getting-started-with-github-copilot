...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for practices and weekend games",
        "schedule": "Tuesdays, Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, build endurance, and improve stroke technique",
    ...
    "Robotics Club": {
        "description": "Design, build, and program robots for challenge events",
